...
Hint: it may be useful to refer back to your solution for the in-class assignment on 9/10. If you’re still having trouble, take a look at the turtle library section of the Python official documentation ( https://docs.python.org/3/library/turtle.html )... or stop by my office hours.
b.	Your picture should depict a recognizable object or scene. For example, something like the following (though it does not need to be this involved):

![Turtle Drawing](images/turtle_drawing.png){ width=400px }
...
1.	Find the Python documentation for the random module. (Hint: Use the link to the “library reference” on the resources tab on Nexus)
...
![Computer Art](images/comp_art.png){ width=400px }
...
Once you have checked these things, submit your code to Project 1: Drawings with Turtle on Gradescope.
